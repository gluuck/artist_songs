...
class DownloadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create download" do
    assert_difference("Download.count") do
      post downloads_url, params: { download: { artist_id: @download.artist_id, song_id: @download.song_id } }
    end
  ...
  test "should update download" do
    patch download_url(@download), params: { download: { artist_id: @download.artist_id, song_id: @download.song_id } }
